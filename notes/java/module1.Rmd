...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("number1")` of `r fmt_keyword("int")` type and assign value `r fmt_output(100)` to it.   
        1. Create variable `r fmt_variable("number2")` of `r fmt_keyword("int")` type and assign value `r fmt_output(80)` to it.     
