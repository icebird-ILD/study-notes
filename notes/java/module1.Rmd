...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("John")` to variable `r fmt_variable("name")`.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("John")` to variable `r fmt_variable("boyName")`.   
        1. Create variable `r fmt_variable("girlName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Maria")` to variable `r fmt_variable("girlName")`.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("age")` of `r fmt_keyword("int")` type and assign value `r fmt_output(21)` to variable `r fmt_variable("age")`.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyAge")` of `r fmt_keyword("int")` type and assign value `r fmt_output(21)` to variable `r fmt_variable("boyAge")`.   
        1. Create variable `r fmt_variable("girlAge")` of `r fmt_keyword("int")` type and assign value `r fmt_output(23)` to variable `r fmt_variable("girlAge")`.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("marks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.1)` to variable `r fmt_variable("marks")`.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyMarks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.1)` to variable `r fmt_variable("boyMarks")`.  
        1. Create variable `r fmt_variable("girlMarks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(8.3)` to variable `r fmt_variable("girlMarks")`.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to variable `r fmt_variable("name")`.  
        1. Create variable `r fmt_variable("age")` of `r fmt_keyword("int")` type and assign value `r fmt_output(22)` to variable `r fmt_variable("age")`.  
        1. Create variable `r fmt_variable("marks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.9)` to variable `r fmt_variable("marks")`.  
        1. Print variable `r fmt_variable("name")`.   
        1. Print variable `r fmt_variable("age")`.   
        1. Print variable `r fmt_variable("marks")`.   
        <br/>
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("firstName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to variable `r fmt_variable("firstName")`.  
        1. Create variable `r fmt_variable("lastName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Michael")` to variable `r fmt_variable("lastName")`.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        ...
        **Steps to perform:**   
        1. Create variable `r fmt_variable("firstName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to variable `r fmt_variable("firstName")`.  
        1. Create variable `r fmt_variable("middleName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Ray")` to variable `r fmt_variable("middleName")`.  
        1. Create variable `r fmt_variable("lastName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Michael")` to variable `r fmt_variable("lastName")`.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        ...
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to variable `r fmt_variable("name")`.  
        1. Create variable `r fmt_variable("score")` of `r fmt_keyword("float")` type and assign value `r fmt_output(8.1)` to variable `r fmt_variable("score")`.  
...
10. **Exercise**:    `r fmt_todo()`       
Addition: Write a Program in jShell file which declares 3 `r text_spec("int", color = "red")` variables such as a=10, b=20, c=a+b. Print value variable c.    

10. **Exercise**:    `r fmt_todo()`       
Subtraction: Write a Program in jShell file which declares 3 `r text_spec("int", color = "red")` variables such as a=100, b=40, c=a-b. Print value variable c.   

10. **Exercise**:    `r fmt_todo()`       
Multiplication: Write a Program in jShell file which declares 3 `r text_spec("int", color = "red")` variables such as a=10, b=20, c=a*b. Print value variable c.    

10. **Exercise**:    `r fmt_todo()`       
Division: Write a Program in jShell file which declares 3 `r text_spec("int", color = "red")` variables such as a=20, b=10, c=a/b. Print value variable c.    
...
Create `r text_spec("class", color = "red")` **MyFirsClass**.   
...
Create `r text_spec("class", color = "red")` **MyClass**.   
...
1. **Exercise**:    `r fmt_todo()`       
Create variable `r text_spec("String", color = "red")` **name** = *"John"*.   
...
Addition:   
Implement `r text_spec("static", color = "red")` method "addition(int number1, int number2)" which prints addition of given arguments.    
Question:
...
12. **Exercise**:    `r fmt_todo()`       
Subtraction:    
Implement `r text_spec("static", color = "red")` method "subtraction(int number1, int number2)" which prints subtraction of given arguments.   
Question:
...
12. **Exercise**:    `r fmt_todo()`       
Square:    
Implement `r text_spec("static", color = "red")` method "square(int number)" which prints square of given argument.   
Question:
...
12. **Exercise**:    `r fmt_todo()`       
Cube:     
Implement `r text_spec("static", color = "red")` method "cube(int number)" which prints cube of given argument.    
Question:
