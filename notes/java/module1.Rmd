...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("John")` to it.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("John")` to it.   
        1. Create variable `r fmt_variable("girlName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Maria")` to it.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("age")` of `r fmt_keyword("int")` type and assign value `r fmt_output(21)` to it.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyAge")` of `r fmt_keyword("int")` type and assign value `r fmt_output(21)` to it.   
        1. Create variable `r fmt_variable("girlAge")` of `r fmt_keyword("int")` type and assign value `r fmt_output(23)` to it.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("marks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.1)` to it.   
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("boyMarks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.1)` to it.  
        1. Create variable `r fmt_variable("girlMarks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(8.3)` to it.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to it.  
        1. Create variable `r fmt_variable("age")` of `r fmt_keyword("int")` type and assign value `r fmt_output(22)` to it.  
        1. Create variable `r fmt_variable("marks")` of `r fmt_keyword("float")` type and assign value `r fmt_output(7.9)` to it.  
        1. Print variable `r fmt_variable("name")`.   
        1. Print variable `r fmt_variable("age")`.   
        1. Print variable `r fmt_variable("marks")`.   
        <br/>
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("firstName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to it.  
        1. Create variable `r fmt_variable("lastName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Michael")` to it.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        ...
        **Steps to perform:**   
        1. Create variable `r fmt_variable("firstName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to it.  
        1. Create variable `r fmt_variable("middleName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Ray")` to it.  
        1. Create variable `r fmt_variable("lastName")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Michael")` to it.  
...
10. **Exercise**:    `r fmt_todo()`       
    - **Description**:    `r fmt_todo()`   
        ...
        **Steps to perform:**   
        1. Create variable `r fmt_variable("name")` of `r fmt_keyword("String")` type and assign value `r fmt_output("Shawn")` to it.  
        1. Create variable `r fmt_variable("score")` of `r fmt_keyword("float")` type and assign value `r fmt_output(8.1)` to it.  
...
Addition: Write a Program in jShell file which declares 3 `r text_spec("int", color = "red")` variables such as a=10, b=20, c=a+b. Print value variable c.    
    - **Description**:    `r fmt_todo()`   
        **Objective:**   
        ...
        <br/>
        **Steps to perform:**   
        1. Create variable `r fmt_variable("number1")` of `r fmt_keyword("int")` type and assign value `r fmt_output(10)` to it.   
        1. Create variable `r fmt_variable("number2")` of `r fmt_keyword("int")` type and assign value `r fmt_output(20)` to it.     
        ...
        1. Print `r fmt_output("Addition reuslt is=")` and variable `r fmt_variable("additionResult")` in a single line.   
        <br/>
    - **Question**:       `r fmt_todo()`   
    ...
    - **Solution**:
                ...
                System.out.println("Addition reuslt is=" + additionResult);  
